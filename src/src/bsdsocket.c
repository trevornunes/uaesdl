...
static uae_u32 bsdsock_int_handler (TrapContext *context)
{
    SB;
...
static uae_u32 bsdsocklib_Expunge (TrapContext *context)
{
...
static uae_u32 bsdsocklib_Open (TrapContext *context)
{
    uae_u32 result = 0;
    int opencount;
    unsigned int i;
...
static uae_u32 bsdsocklib_Close (TrapContext *context)
{
    int opencount;
...
static uae_u32 bsdsocklib_socket (TrapContext *context)
{
...
static uae_u32 bsdsocklib_bind (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_listen (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_accept (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_connect (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_sendto (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_send (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
    host_sendto (context, sb, m68k_dreg (regs, 0), m68k_areg (regs, 0), m68k_dreg (regs, 1),
...
static uae_u32 bsdsocklib_recvfrom (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_recv (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
    host_recvfrom (context, sb, m68k_dreg (regs, 0), m68k_areg (regs, 0), m68k_dreg (regs, 1),
		   m68k_dreg (regs, 2), 0, 0);
...
static uae_u32 bsdsocklib_shutdown (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_setsockopt (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_getsockopt (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_getsockname (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_getpeername (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_IoctlSocket (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
/* CloseSocket(d)(d0) */
static uae_u32 bsdsocklib_CloseSocket (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_WaitSelect (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_SetSocketSignals (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_ObtainSocket (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
    int sd;
    long id;
...
static uae_u32 bsdsocklib_ReleaseSocket (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
    int sd;
    long id;
...
static uae_u32 bsdsocklib_ReleaseCopyOfSocket (TrapContext *context)
{
...
/* Errno()() */
static uae_u32 bsdsocklib_Errno (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
    TRACE (("Errno() -> %d\n", sb->sb_errno));
    return sb->sb_errno;
...
static uae_u32 bsdsocklib_SetErrnoPtr (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
/* Inet_NtoA(in)(d0) */
static uae_u32 bsdsocklib_Inet_NtoA (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
/* inet_addr(cp)(a0) */
static uae_u32 bsdsocklib_inet_addr (TrapContext *context)
{
    return host_inet_addr (m68k_areg (regs, 0));
}

/* Inet_LnaOf(in)(d0) */
static uae_u32 bsdsocklib_Inet_LnaOf (TrapContext *context)
{
...
/* Inet_NetOf(in)(d0) */
static uae_u32 bsdsocklib_Inet_NetOf (TrapContext *context)
{
...
static uae_u32 bsdsocklib_Inet_MakeAddr (TrapContext *context)
{
...
/* inet_network(cp)(a0) */
static uae_u32 bsdsocklib_inet_network (TrapContext *context)
{
    return host_inet_addr (m68k_areg (regs, 0));
}
...
static uae_u32 bsdsocklib_gethostbyname (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_gethostbyaddr (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_getnetbyname (TrapContext *context)
{
...
static uae_u32 bsdsocklib_getnetbyaddr (TrapContext *context)
{
...
static uae_u32 bsdsocklib_getservbyname (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_getservbyport (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_getprotobyname (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_getprotobynumber (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_vsyslog (TrapContext *context)
{
...
static uae_u32 bsdsocklib_Dup2Socket (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
    return host_dup2socket (sb, m68k_dreg (regs, 0), m68k_dreg (regs, 1));
}

static uae_u32 bsdsocklib_sendmsg (TrapContext *context)
{
    write_log ("bsdsocket: UNSUPPORTED: sendmsg()\n");
    return 0;
}

static uae_u32 bsdsocklib_recvmsg (TrapContext *context)
{
    write_log ("bsdsocket: UNSUPPORTED: recvmsg()\n");
    return 0;
}

static uae_u32 bsdsocklib_gethostname (TrapContext *context)
{
    return host_gethostname (m68k_areg (regs, 0), m68k_dreg (regs, 0));
}

static uae_u32 bsdsocklib_gethostid (TrapContext *context)
{
...
static uae_u32 bsdsocklib_SocketBaseTagList (TrapContext *context)
{
    struct socketbase *sb = get_socketbase (context);
...
static uae_u32 bsdsocklib_GetSocketEvents (TrapContext *context)
{
#ifdef _WIN32
    struct socketbase *sb = get_socketbase (context);
    int i;
...
static uae_u32 bsdsocklib_getdtablesize (TrapContext *context)
{
    return get_socketbase (context)->dtablesize;
}

static uae_u32 bsdsocklib_null (TrapContext *context)
{
    return 0;
}

static uae_u32 bsdsocklib_init (TrapContext *context)
{
    uae_u32 tmp1;
    int i;
