...
static struct uae_hotkeyseq sdl_hotkeys[] =
{
    ...
    { MAKE_HOTKEYSEQ (SDLK_F12, SDLK_KP_PLUS, -1, -1,     INPUTEVENT_SPC_INCREASE_REFRESHRATE) },
    { MAKE_HOTKEYSEQ (SDLK_F12, SDLK_KP_MINUS, -1, -1,    INPUTEVENT_SPC_DECREASE_REFRESHRATE) },
...
static struct uae_hotkeyseq sdl_quartz_hotkeys[] =
{
    ...
    { MAKE_HOTKEYSEQ (SDLK_F11, SDLK_KP_PLUS, -1, -1,     INPUTEVENT_SPC_INCREASE_REFRESHRATE) },
    { MAKE_HOTKEYSEQ (SDLK_F11, SDLK_KP_MINUS, -1, -1,    INPUTEVENT_SPC_DECREASE_REFRESHRATE) },
